...
<body>
	...
	<form method="POST" action="AddFlight">
		...
		<br /> Day of month: <input name="day" type="text"></input> <br />
		<br /> Hour of day (0 - 23): <input name="hour" type="text"></input>

		<br />
		<br /> Minute (0 - 59): <input name="minute" type="text"></input> <br />
		<br /> Price: <input name="price" type="text"></input>

		<hr />

		<h4>Airplane:</h4>

		Plane make: <input name="airplane_make" type="text"></input> <br />
		<br /> Model name: <input name="airplane_model" type="text"></input>

		<br />
		<br /> Seating: <input name="airplane_seating" type="text"></input>
	...
	<form method="POST" action="CreatePilotAndAddToFlight">
		...
		First name: <input name="first_name" type="text"></input> <br />
		<br /> Last name: <input name="last_name" type="text"></input> <br />
		<br /> License: <input name="license" type="text"></input> <br />
		...
		<br /> Flight Id: <input name="fid" type="text"></input>
	...
	<form method="POST" action="AddPassenger">
		...
		First name: <input name="first_name" type="text"></input> <br />
		<br /> Last name: <input name="last_name" type="text"></input> <br />
		<br /> Date of birth: <input name="dob" type="text"></input> <br />
	...
	<form method="POST" action="AddPassengerToFlight">
		...
		Add a passenger with an id of <input name="pid" type="text"></input>

		to a flight with an id of <input name="fid" type="text"></input>
	...
	<h1>
		Add flight to passenger <span
			style="font-size: 16px; vertical-align: middle;">(give a
	...
	<form method="post" action="AddFlightTicketToPassenger">
		...
		Add a ticket for a flight with an id of <input name="fid" type="text"></input>

		to a passenger with an id of <input name="pid" type="text"></input> <br />
		<br /> <span style="font-weight: bold;">(In real world terms -
			add the flight ticket to the passenger's collection of flight
			tickets)</span>
