...
/**
 * Servlet implementation class CreatrePilotAndAddToFlight
 */
...
public class CreatePilotAndAddToFlight extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		newpilot.setPilotLicense(licence);
		newpilot.setPilotRank(PilotRank.valueOf(rank));		
		
		pilotService.addNewPilotToFlight(newpilot, flightId);
